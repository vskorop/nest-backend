...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        function AuthController_1(client) {
            this.client = (__runInitializers(this, _instanceExtraInitializers), client);
        }
        AuthController_1.prototype.onModuleInit = function () {
            this.authService = this.client.getService('AuthService');
        };
        AuthController_1.prototype.validateUser = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.validateUser(data.username, data.password)];
                });
            });
        };
        AuthController_1.prototype.login = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.login(data)];
                });
            });
        };
    ...
    (function () {
        ...
        _validateUser_decorators = [(0, microservices_1.GrpcMethod)('AuthService', 'ValidateUser')];
        _login_decorators = [(0, microservices_1.GrpcMethod)('AuthService', 'Login')];
        _register_decorators = [(0, microservices_1.GrpcMethod)('AuthService', 'Register')];
